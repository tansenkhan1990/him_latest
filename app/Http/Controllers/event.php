...
class event extends Controller
{
    ...
    public function getEventPage()
    {
       ...
       $c=$a->select("SELECT d.datum, d.`datum-bis` AS poko, `event` from dates d, events e
 where e.id = d.event");
        $b=$a->select("SELECT * from
personen,events WHERE events.verantwortlicher=personen.id ORDER BY events.id DESC");
